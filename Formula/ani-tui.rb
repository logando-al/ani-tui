class AniTui < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/logando-al/ani-tui/releases/download/v1.0.2/ani-tui-macos-aarch64"
    sha256 "REPLACE_WITH_MACOS_AARCH64_SHA256"
  else
    url "https://github.com/logando-al/ani-tui/releases/download/v1.0.2/ani-tui-macos-x86_64"
